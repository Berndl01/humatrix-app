    ...
    <div className="min-h-screen px-4 py-12" style={{ background: '#010C1A', color: 'rgba(255,255,255,0.85)' }}>
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-extrabold mb-8" style={{ fontFamily: 'Barlow Condensed' }}>
          <span style={{ color: '#2FA7BC' }}>Impressum</span> & Datenschutz
        </h1>

        <div className="space-y-8">
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ fontFamily: 'Barlow Condensed', color: '#2FA7BC' }}>Impressum</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ fontFamily: 'Barlow Condensed', color: '#2FA7BC' }}>Datenschutz</h2>
            <div className="text-sm leading-relaxed space-y-3" style={{ color: 'var(--text)' }}>
              <p>Die Humatrix App verarbeitet personenbezogene Daten ausschließlich zum Zweck der Spielertyp-Analyse und Mannschaftsentwicklung.</p>
